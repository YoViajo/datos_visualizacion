## Ref: https://albert-rapp.de/post/2022-03-29-recreating-the-swd-look/
...
# Cambiar los ejes: nombres de almacenes en el eje Y
...
# Destacar los puntos de la historia
...
# Quitar expansión de ejes y permitir dibujar fuera de la cuadrícula
p <- p +
  coord_cartesian(
    xlim = c(0, 1), 
    ylim = c(0.5, 20.5), 
...
# Añadir descripciones de categoría
library(ggtext)
p <- p +
  annotate(
    'richtext',
...
# Añadir el mensaje principal como un nuevo título y subtítulo
...
# Conseguir las tallas correctas
